$(document).ready(function () {
    ...
    function arrayHunt() {
         ...
         */
        let longestString = longestStringFromArray(myArray);
         ...
         */
       let noS = document.myArray.innerHTML = myArray.every('s');
        $("td#noEss").text(noS);
